...
/** Stable texture-compositing path retained independently of experimental surface rendering. */
final class ClassicArmorMudRenderer {
    private static final Map<Long, Long> COMPOSITED_SLOTS = new HashMap<>();
    private static long compositedGameTime = Long.MIN_VALUE;

    private ClassicArmorMudRenderer() {
    }
