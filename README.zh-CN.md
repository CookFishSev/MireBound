...
当前开发版本：`MireBound-Beta1.3.0-MC1.21.1-NeoForge`。

---

### 注:此项目作者现实时间并不充裕,而且此项目缺乏美术。
### 你可以加入 `QQ交流群:493537400` 发表意见!   Discord服务器正在积极搭建中。
...
- **报告 Bug**：请前往 [GitHub Issues](https://github.com/CookFishSev/MireBound/issues) 提交问题。提交时请务必附上：
  - 模组版本（如 `MireBound-Beta1.3.0-MC1.21.1-NeoForge`）；
